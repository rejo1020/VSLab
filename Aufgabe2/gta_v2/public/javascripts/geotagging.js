    ...
    return { // Start öffentlicher Teil des Moduls ...
        ...
        updateLocation: function(){
            tryLocate(function(position){
                ...
                document.getElementById("tag-form_latitude").value = getLatitude(position);
                document.getElementById("tag-form_longitude").value = getLongitude(position);
                document.getElementById("filter-form_latitude").value = getLatitude(position);
                document.getElementById("filter-form_longitude").value = getLongitude(position);
